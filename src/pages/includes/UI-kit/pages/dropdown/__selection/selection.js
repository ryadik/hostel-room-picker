const btnsDecrement = document.querySelectorAll('.option-button__decrement'),
      btnsIncrement = document.querySelectorAll('.option-button__increment'),
      selectionText = document.querySelectorAll('.dropdown__selection')
...
for (let i = 0; i < selectionText.length; i++) {
  ...
  if (selectionText[i].dataset.id == (i + 1)) {
    selectionText[i].addEventListener('click', function() {
